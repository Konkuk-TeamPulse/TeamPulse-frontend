...
export function HomePage({ workspace, tasks, completion, formatDate, onCreateInviteLink }: HomePageProps) {
  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_240px_240px]">
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <aside className="grid gap-5">
          <InviteLinkCard inviteUrl={workspace.team.inviteUrl ?? ''} inviteExpiredAt={workspace.team.inviteExpiredAt} onCreateInviteLink={onCreateInviteLink} />
