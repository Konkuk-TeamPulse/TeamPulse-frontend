    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <div className="min-w-0 lg:pl-[224px]">
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-slate-200 bg-white/90 px-4 backdrop-blur sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <button type="button" className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-bold text-slate-600 hover:bg-slate-50 lg:hidden" onClick={onExitProject}>메인으로 돌아가기</button>
